...
<body>
                    ...
                    <li id="day" class="calendar_data__content">
                        ...
                        <ul class="shop_sale__data_list">
                            <li class="shop_sale__data_list__data">
                                ...
                                <p id="shop_amount" class="shop_sale__data_list__value">¥0</p>
                                <p id="shop_dayBeforeRatio" class="shop_sale__data_list__difference"><span>前日差</span><span
                                        class="yen">¥0</span></p>
                            </li>
                            <li class="shop_sale__data_list__data">
                                <p class="shop_sale__data_list__name">報酬額</p>
                                <p id="shop_sellers_reward" class="shop_sale__data_list__value">¥0</p>
                            </li>
                            <li class="shop_sale__data_list__data">
                                <p class="shop_sale__data_list__name">販売個数</p>
                                <p id="shop_quantity" class="shop_sale__data_list__value">0</p>
                            </li>
                            @if ($shops)
                            <li class="store_list">
                    ...
                    <li id="month" class="calendar_data__content">
                        ...
                        <ul class="shop_sale__data_list">
                            <li class="shop_sale__data_list__data">
                                <p class="shop_sale__data_list__name">売上</p>
                                <p id="shop_amount" class="shop_sale__data_list__value">¥0</p>
                                <p id="shop_dayBeforeRatio" class="shop_sale__data_list__difference"><span>前月差</span><span class="yen">¥0</span></p>
                            </li>
                            <li class="shop_sale__data_list__data">
                                <p class="shop_sale__data_list__name">報酬額</p>
                                <p id="sellers_reward" class="shop_sale__data_list__value">¥0</p>
                            </li>
                            <li class="shop_sale__data_list__data">
                                <p class="shop_sale__data_list__name">販売個数</p>
                                <p id="shop_quantity" class="shop_sale__data_list__value">0</p>
    ...
    <script src="{{ mix('js/shop/shopCalender.js') }}"></script>
