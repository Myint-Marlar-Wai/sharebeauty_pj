...
return [
    ...
    */
    ...
    'attributes' => [
        'demo_form_id' => 'デモフォームID',
        'demo_form_enum' => 'デモフォーム列挙体',
        ...
        'bank_code' => '金融機関コード',
        'bank_account_type' => '預金種別',
        'display_order_id' => '受注番号',
        'order_id' => '受注番号',
        'display_shop_id' => 'ショップID',
        'shop_id' => 'ショップID',
        'seller_id' => '販売者ID',
        'display_seller_id' => '販売者ID',
        'member_id' => '会員ID',
        'display_member_id' => '会員ID',
        'admin_id' => '管理者ID',
    ],
