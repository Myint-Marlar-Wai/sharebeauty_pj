...
use App\Http\ViewResources\Seller\Auth\PasswordResetViewResource;
use App\Http\ViewResources\Seller\Auth\PasswordUpdateViewResource;
...
class PasswordResetController extends BaseController
{
    ...
    {
        return view('seller.auth.password-reset', [
    ...
    public function postSendRestLink(PasswordResetSendLinkRequest $request): RedirectResponse
    {
        ...
        $broker = SellerAuth::passwordBroker();
        ...
        if ($status == Password::RESET_LINK_SENT) {
            return SellerRoutes::toPasswordResetSendLinkCompleted();
        } else {
    ...
    {
        return view('seller.auth.password-reset-completed', [
    ...
    {
        return view('seller.auth.password-update', [
    ...
    public function postUpdatePerform(PasswordResetUpdatePerformRequest $request): RedirectResponse
    {
        ...
        $status = $broker->reset(
            ...
            function (SellerAuthUser $user, \App\Data\Common\Password $password) use ($email) {
        ...
        if ($status == Password::PASSWORD_RESET) {
            return SellerRoutes::toPasswordResetUpdateCompleted();
        } else {
    ...
    {
        return view('seller.auth.password-update-completed', [
            'vr' => DefaultViewResource::make($request),
        ]);
    }
}
